...
class ImageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        /*  Using UIImage(named:) causes the image to be cached.  OK, if needed for
            later or the images are small.  However, our images are large an not likely to
            be required again
